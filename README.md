...
This tutorial outlines the implementation of on-premises Active Directory within Azure Virtual Machines. It also outlines how to create accounts, set permissions, lock and unlock accounts, and Group Policy. <br />
